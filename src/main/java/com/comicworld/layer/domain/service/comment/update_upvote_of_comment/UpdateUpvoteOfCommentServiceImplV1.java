...
@Service("updateUpvoteOfCommentServiceImplV1")
@Transactional
public class UpdateUpvoteOfCommentServiceImplV1 implements UpdateUpvoteOfCommentService {
    ...
    public ResponseEntity<Object> update(Long commentId, String action) {
        try {
            this.commentService.updateUpvoteById(commentId, action);
