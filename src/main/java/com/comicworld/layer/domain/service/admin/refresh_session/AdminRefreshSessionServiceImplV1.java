...
@Service("adminRefreshSessionServiceImplV1")
@Transactional
public class AdminRefreshSessionServiceImplV1 implements AdminRefreshSessionService {
    ...
    public ResponseEntity<Object> refreshSession(String refreshToken) {
        ...
        Set<Authority> authorities = this.authorityService.findByAdminAccountId(accountId);
