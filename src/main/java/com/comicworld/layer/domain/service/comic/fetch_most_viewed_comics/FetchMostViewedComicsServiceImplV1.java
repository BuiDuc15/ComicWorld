...
@Service("fetchMostViewedComicsServiceImplV1")
public class FetchMostViewedComicsServiceImplV1 implements FetchMostViewedComicsService {
    ...
    public ResponseEntity<Object> fetch() {
        List<Comic> comics = this.comicService.findTop10MostViewedComicsWithChaptersLoadedEagerly();
