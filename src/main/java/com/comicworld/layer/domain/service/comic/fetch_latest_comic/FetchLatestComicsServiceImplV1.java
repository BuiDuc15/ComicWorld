...
@Service("fetchLatestComicsServiceImplV1")
public class FetchLatestComicsServiceImplV1 implements FetchLatestComicsService {
    ...
    public ResponseEntity<Object> fetch() {
        List<Comic> comics = this.comicService.findTop10LatestComicsWithChaptersLoadedEagerly();
