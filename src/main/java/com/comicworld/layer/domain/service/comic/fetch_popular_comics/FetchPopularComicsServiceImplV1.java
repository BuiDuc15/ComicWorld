...
@Service("fetchPopularComicsServiceImplV1")
public class FetchPopularComicsServiceImplV1 implements FetchPopularComicsService {
    ...
    public ResponseEntity<Object> fetch() {
        List<Comic> comics = this.comicService.findTop10MostPopularComicsWithChaptersLoadedEagerly();
