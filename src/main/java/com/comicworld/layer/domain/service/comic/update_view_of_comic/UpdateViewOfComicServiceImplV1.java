...
@Service("updateViewOfComicServiceImplV1")
@Transactional
public class UpdateViewOfComicServiceImplV1 implements UpdateViewOfComicService {
    ...
    public ResponseEntity<Object> update(Long id) {
        ...
        while(status) {
            try {
                this.comicService.updateViewOfComicById(id);
                status = false;
            }
