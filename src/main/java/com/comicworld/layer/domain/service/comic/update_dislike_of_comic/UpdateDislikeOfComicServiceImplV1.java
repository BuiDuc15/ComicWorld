...
@Service("updateDislikeOfComicServiceImplV1")
@Transactional
public class UpdateDislikeOfComicServiceImplV1 implements UpdateDislikeOfComicService {
    ...
    public ResponseEntity<Object> update(Long id, String action) {
        ...
        while(status) {
            try {
                this.comicService.updateDislikeOfComicById(id, action);
                status = false;
            }
